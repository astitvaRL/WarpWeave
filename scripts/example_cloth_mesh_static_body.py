...
###########################################################################
# Example Sim Cloth Mesh
#
# Shows a simulation of a cloth garment loaded from an OBJ mesh file.
# The cloth interacts with a static body mesh using wp.sim.ModelBuilder().
# This example allows loading both a garment mesh and a body mesh for
# garment simulation.
#
###########################################################################
